...
public class Quiz2 {
    ...
    public void testUntitledTestCase() throws Exception {
        driver.get("https://quiz.forbes.com/how-strange-do-you-find-stranger-things-spa-va2/");
...
//            System.out.println("Image Credits: "+((WebElement)credits.get(i-1)).getAttribute("innerHTML"));
           ...
           // driver.findElement(By.xpath("//div[@class=\"hint-screen\"]//span[@class=\"continue\"]")).click();
            String xpath = "//div[@class=\"qoptions w-90 flx-1\"]//li["+option+"]";
            driver.findElement(By.xpath(xpath)).click();
//            JavascriptExecutor js = (JavascriptExecutor) driver;
//            js.executeScript("window.scrollBy(0,1000)");
//            Thread.sleep(3000);
            driver.findElement(By.xpath("//span[@class=\"n-b\"]")).click();
            Thread.sleep(1000);
            System.out.println("*************************************************************");
        }
    }
