...
//        System.setProperty("webdriver.gecko.driver",ffDriverPath);
               ...
               //caps.addExtensions(new File("C:\\Users\\krish.t\\Desktop\\quiz\\PureVPN.crx"));
        caps.addArguments("load-extension=C:\\Users\\krish.t\\Downloads\\PureVPN");
        ...
        public void runTest() throws Exception {
            ...
            driver.get("chrome-extension://nfgkgpgbollnabmhdongkoppdapbmaep/ui/popup/template.html");
            driver.navigate().refresh();
            ArrayList<String> tabs2 = new ArrayList<String> (driver.getWindowHandles());
            driver.switchTo().window(tabs2.get(0));            // System.out.println("Refresh successfully");
           driver.manage().window().maximize();
            driver.findElement(By.cssSelector(".btn-login")).click();
            //driver.navigate().refresh();
            driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
            driver.findElement(By.cssSelector(".username")).sendKeys("purevpn0s813421");
            driver.findElement(By.cssSelector(".password")).sendKeys("o24cwtc7");
            Thread.sleep(3000);
            driver.findElement(By.id("btnLogin")).click();
            driver.manage().timeouts().implicitlyWait(8, TimeUnit.SECONDS);

            WebElement element = driver.findElement(By.xpath("//*[contains(text(), 'Connect')]"));
