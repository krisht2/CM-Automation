...
public class AdvisorCheckMobile {
   WebDriver driver;
   ...
   //        System.setProperty("webdriver.gecko.driver",ffDriverPath);
               ...
               String extentReportFile = System.getProperty("user.dir")+"\\MobileAdvisorHomepage.html";
...
//                    System.out.println("New : " + startGA + " " + stopGA + " " + difference + " ");
    ...
    public void DFPCheck() throws Exception{
       try{
        ...
        if(DFPEnabled){
            ...
            List<WebElement> topAd =driver.findElements(By.className("inline-article-ed-placeholder"));
            System.out.println("expected ads: "+topAd.size());
            ...
            List<WebElement> recAds =driver.findElements(By.className("mobile-sticky-ed-placeholder"));
            System.out.println("REC expected ads: "+recAds.size());
   ...
   public void closeTest(){
    ...
    public void sendEmail() throws EmailException {
        ...
        attachment.setPath(System.getProperty("user.dir")+"\\MobileAdvisorHomepage.html");
